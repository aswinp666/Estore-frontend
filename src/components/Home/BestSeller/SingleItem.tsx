...
import { Product } from "@/types/product"; // Ensure this path is correct and Product type is updated
    ...
    <div className="group">
      <div className="relative overflow-hidden rounded-lg bg-[#F6F7FB] min-h-[403px]">
        <div className="text-center px-4 py-7.5">
          ...
          {/* Ensure discountedPrice is handled correctly. Assuming it's optional for `item` */}
          <span className="flex items-center justify-center gap-2 font-medium text-lg">
            <span className="text-dark">${item.discountedPrice !== undefined ? item.discountedPrice : item.price}</span>
